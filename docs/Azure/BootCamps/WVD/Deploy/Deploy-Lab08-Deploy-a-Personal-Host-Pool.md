...
4. Open PowerShell and enter the following command:
    ...
    ```Powershell
    Add-RdsAppGroupUser <enteryourtenantname> -HostPoolName "<enter host pool name>" -AppGrouName "Desktop Application Group" -UserPrincipalName Bob.Jones@<yourdomain>.onmicrosoft.com
    ```
