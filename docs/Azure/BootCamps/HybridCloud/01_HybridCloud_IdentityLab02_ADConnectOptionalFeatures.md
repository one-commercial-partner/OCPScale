...
3. Logon and then select **Pass-through Authentication** as the sign-in method. Click **Next**.
4. Enter the credentials for your AD domain and click **Next**.
5. Click **Configure**. On successful completion, a Pass-through Authentication Agent is installed on the  Azure AD Connect virtual machine and the feature is enabled on your tenant.  Click **Exit** when complete.
